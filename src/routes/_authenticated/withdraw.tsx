...
export const Route = createFileRoute("/_authenticated/withdraw")({
  head: () =>
    meta("Penarikan Manual", "Ajukan penarikan saldo ke rekening bank atau e-wallet Anda."),
  component: Page,
});
...
function Page() {
  ...
  async function submit(e: FormEvent) {
    ...
    try {
      ...
      setMsg(
        "Permintaan penarikan terkirim. Admin akan mentransfer manual dan mengirim bukti transfernya di sini.",
      );
      setAmount("");
      await load();
    } catch (e2) {
  ...
  return (
    <AppShell back="/profile" title="PENARIKAN MANUAL">
      <PageIntro eyebrow="TARIK SALDO" title="Penarikan ke rekening Anda">
        Kirim nomor rekening atau e-wallet beserta nominalnya. Admin mentransfer manual lalu
      ...
      <Notice>
        Pastikan nama dan nomor rekening benar. Kesalahan data dapat memperlambat proses transfer.
      </Notice>
